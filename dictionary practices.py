...
userinput = input('Please enter state abbreviation Your entry must be uppercase')
if userinput == ("CO"):
 print (governors["Colorado"])

elif userinput == ("AL"):
 print (governors["Alabama"])

elif userinput == ("AK"):
 print (governors["Alaska"])

elif userinput == ("AZ"):
 print (governors["Arizona"])

elif userinput == ("AK"):
 print (governors["Arkansas"])

elif userinput == ("CA"):
 print (governors["California"])

elif userinput == ("CT"):
 print (governors["Connecticut"])

elif userinput == ("DE"):
 print (governors["Delaware"])

elif userinput == ("FL"):
 print (governors["Florida'"])

elif userinput == ("GA"):
 print (governors["Georgia'"])

elif userinput == ("HI"):
 print (governors["Hawaii'"])